    ...
    return (
        ...
        <div className="flex flex-col items-center justify-center h-screen">
            ...
            <div className="flex flex-col items-center justify-center">
                ...
                <p className="md:text-lg lg:text-xl mt-8" style={{ color: 'var(--color-primary)' }}>Ya puedes iniciar sesión</p>
                <Link to="/login" className="p-3 m-5 w-full text-center bg-gray-600 text-slate-300 border rounded-xl hover:scale-110 duration-300 hover:bg-gray-900 hover:text-white"
                    style={{ backgroundColor: 'var(--color-primary)', color: 'white' }}>Login</Link>
            </div>
